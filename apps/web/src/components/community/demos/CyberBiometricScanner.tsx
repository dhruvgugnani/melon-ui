...
export interface CyberBiometricScannerProps extends React.ComponentPropsWithoutRef<"div"> {
  title?: string;
  subtitle?: string;
  successText?: string;
  primaryColor?: string;
...
export const CyberBiometricScanner = React.forwardRef<HTMLDivElement, CyberBiometricScannerProps>(
  (
    {
...
CyberBiometricScanner.displayName = "CyberBiometricScanner";
