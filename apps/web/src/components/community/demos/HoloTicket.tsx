      ...
      >
        ...
        >
          ...
          <div className="p-6 relative z-10">
            ...
            <h3 className="text-4xl font-black uppercase tracking-tighter mb-1" style={{ fontFamily: "var(--font-anton)", color: topTextColor }}>
              {topTitle}
            </h3>
            <p className="font-mono text-xs mb-4" style={{ color: topSubtitleColor }}>
              {topSubtitle}
            </p>
