...
export function TetheredOrbitalVault({
  ...
  const handleDragEnd = (event: MouseEvent | TouchEvent | PointerEvent, info: PanInfo, id: string, controls: import("framer-motion").AnimationControls) => {
...
function DraggableKey({
  ...
  isLocked: boolean;
  onDragStart: () => void;
  onDragEnd: (event: MouseEvent | TouchEvent | PointerEvent, info: PanInfo, id: string, controls: import("framer-motion").AnimationControls) => void;
