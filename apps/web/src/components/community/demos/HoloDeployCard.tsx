...
export interface HoloDeployCardProps extends React.ComponentPropsWithoutRef<"div"> {
  title?: string;
  subtitle?: string;
  primaryColor?: string;
...
export function HoloDeployCard({
  title = "CORE SYSTEM",
  ...
  const springConfig = { type: "spring", stiffness: 180, damping: 15, mass: 1 };
