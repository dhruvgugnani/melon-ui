...
export const componentsData: ComponentData[] = [
  {
    id: "hyper-morph-bento",
    slug: "hyper-morph-bento",
    title: "Hyper Morph Bento",
    description: "A fluid, highly interactive glassmorphic bento grid that morphs seamlessly into a split-pane interface using layout transitions. Perfect for futuristic dashboards.",
    category: "Layout",
    tags: ["bento", "morph", "grid", "framer-motion", "dashboard", "glassmorphism"],
    cliCommand: "npx @melonui-dev/cli add hyper-morph-bento",
