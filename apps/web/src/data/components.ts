...
export const componentsData: ComponentData[] = [
  {
    ...
    cliCommand: "npx melonui add synapse-terminal",
    componentPath: "components/community/demos/SynapseTerminal.tsx",
    scrollable: false,
    usageCode: `import { SynapseTerminal } from "@/components/SynapseTerminal";
...
export interface SynapseTerminalProps {
  nodes?: SynapseNode[];
  containerBg?: string;
  accentColor?: string;
  title?: string;
