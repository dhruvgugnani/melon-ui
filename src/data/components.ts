...
export const componentsData: ComponentData[] = [
  {
    ...
    tags: ["GSAP", "Timeline"],
    cliCommand: "npx @melonui/cli add cli-terminal",
    codeSnippet: `npm install -g @melonui/cli\nnpx @melonui/cli init\nnpx @melonui/cli add burst-button`,
  ...
  },
  {
    ...
    category: "Getting Started",
    tags: ["GSAP", "Accordion"],
    cliCommand: "npx @melonui/cli add changelog",
  ...
  },
  {
    ...
    category: "Buttons",
    tags: ["GSAP", "Physics"],
    cliCommand: "npx @melonui/cli add burst-button",
  ...
  },
  {
    ...
    category: "Buttons",
    tags: ["GSAP", "Ripple"],
    cliCommand: "npx @melonui/cli add ripple-button",
  ...
  },
  {
    ...
    tags: ["GSAP", "Elastic"],
    cliCommand: "npx @melonui/cli add magnetic-nav",
  ...
  },
  {
    ...
    category: "Navigations",
    tags: ["GSAP", "Progress"],
    cliCommand: "npx @melonui/cli add step-trail",
  ...
  },
  {
    ...
    category: "Cards",
    tags: ["GSAP", "Transform"],
    cliCommand: "npx @melonui/cli add peel-card",
  ...
  },
  {
    ...
    category: "Cards",
    tags: ["GSAP", "3D", "CSS"],
    cliCommand: "npx @melonui/cli add flip-card",
  ...
  },
  {
    ...
    category: "Inputs",
    tags: ["GSAP", "SVG"],
    cliCommand: "npx @melonui/cli add grow-input",
  ...
  },
  {
    ...
    category: "Inputs",
    tags: ["GSAP", "Input"],
    cliCommand: "npx @melonui/cli add tag-input",
  ...
  },
  {
    ...
    tags: ["Three.js", "R3F"],
    cliCommand: "npx @melonui/cli add particle-field",
  ...
  },
  {
    ...
    category: "3D Backgrounds",
    tags: ["Three.js", "R3F"],
    cliCommand: "npx @melonui/cli add floating-orbs",
  ...
  },
  {
    ...
    category: "Cursors",
    tags: ["GSAP", "Cursor"],
    cliCommand: "npx @melonui/cli add blob-cursor",
  ...
  },
  {
    ...
    category: "Cursors",
    tags: ["GSAP", "Cursor"],
    cliCommand: "npx @melonui/cli add crosshair",
  ...
  },
  {
    ...
    cliCommand: "npx @melonui/cli add char-reveal",
  ...
  },
  {
    ...
    category: "Scroll Effects",
    tags: ["GSAP", "Parallax"],
    cliCommand: "npx @melonui/cli add parallax-strips",
  ...
  },
  {
    ...
    category: "GSAP Text",
    tags: ["GSAP", "Elastic"],
    cliCommand: "npx @melonui/cli add drip-text",
  ...
  },
  {
    ...
    category: "GSAP Text",
    tags: ["GSAP", "Text"],
    cliCommand: "npx @melonui/cli add scramble-text",
  ...
  },
  {
    ...
    tags: ["GSAP", "Timeline"],
    cliCommand: "npx @melonui/cli add stripe-wipe",
  ...
  },
  {
    ...
    category: "Page Transitions",
    tags: ["GSAP", "Clip"],
    cliCommand: "npx @melonui/cli add morph-transition",
